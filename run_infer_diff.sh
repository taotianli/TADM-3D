...
python tasks/infer_diff_model.py \
    --dataset     /nfs/home/ttao/Data/paired_oasis/pairwise_oasis/ \
    --diff_ckpt   /nfs/home/ttao/Projects/TADM-3D/checkpoints/unet-best.pth \
    --output_dir  /nfs/home/ttao/Projects/TADM-3D/outputs/infer_5 \
    --n_samples   5 \
    --split       test \
    --num_workers 4
