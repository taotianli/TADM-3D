...
def init_autoencoder(checkpoints_path = None):
    """
...
def init_patch_discriminator(checkpoints_path = None):
    """
...
class KLDivergenceLoss:
    ...
    def __call__(self, z_mu, z_sigma):
        """
...
class AverageLoss:
    ...
    def put(self, loss_key, loss_value):
        """
        Store value
